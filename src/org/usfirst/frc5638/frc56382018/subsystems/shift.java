...
public class shift extends Subsystem {
    ...
    private final DoubleSolenoid doubleSolenoidshift = RobotMap.shiftDoubleSolenoidshift;
    ...
    public void shiftUP() {
    	...
    	doubleSolenoidshift.set(Value.kForward);
    }
    public void shiftDO() {
    	doubleSolenoidshift.set(Value.kReverse);
    }
